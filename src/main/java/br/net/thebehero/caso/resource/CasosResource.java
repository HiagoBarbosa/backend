package br.net.thebehero.caso.resource;
...
import br.net.thebehero.caso.repository.Casos;
import br.net.thebehero.caso.model.*;
...
public class CasosResource {
	...
	@PostMapping
	public Caso adicionar( @RequestBody Caso caso) {
